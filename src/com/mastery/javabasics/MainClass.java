...
public class MainClass {
	...
	public static void main(String[] args) {
		...
		// Create an instance of DataArrays to demonstrate two-dimensional array
		// printing
		...
		// DataArrays.intersectionOfArrays(ar1, ar2);
		...
		// new ArrayOperations().evenOrOdd();

		// ArrayOperations.removeDuplicates();

		// ArrayOperations.removeDuplicates2();

		// ArrayOperations.printDuplicateElements2();

		// new ArrayOperations().printSecondLargestNumber();

		// ArrayOperations.commonElement();
		
		new ArrayOperations().mostFrquentElements();
